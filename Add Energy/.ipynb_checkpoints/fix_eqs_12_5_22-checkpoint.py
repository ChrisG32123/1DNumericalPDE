...
def solve():
    ...
    v[:] = np.ones(N) + .01 * np.random.random(N)
    e[:] = np.ones(N) + .01 * np.random.random(N)
    ...
    # for ii in range(len(syssnaptot)):
    #     plt.figure()
    #     clr = plt.imshow(syssnaptot[ii, 0], aspect='auto', origin='lower', extent=(0,Xlngth,0,t))
    #     plt.colorbar()
    #     plt.title(syssnapname[ii][0] + " Gamma_0 = " + str(Gamma_0) + " kappa_0 = " + str(kappa_0))
    #
    # for ii in range(len(syssnapfluxtot)):
    #     plt.figure()
    #     clr = plt.imshow(syssnapfluxtot[ii, 0], aspect='auto', origin='lower', extent=(0,Xlngth,0,t))
    #     plt.colorbar()
    #     plt.title(syssnapfluxname[ii][0] + " Gamma_0 = " + str(Gamma_0) + " kappa_0 = " + str(kappa_0))
